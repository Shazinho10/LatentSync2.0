...
from latentsync.models.self_attention import SelfAttention
...
class FixedUNetWithAttention(nn.Module):
    """A Fixed UNet with proper dimension handling for (480, 5, 384) input"""
    def __init__(self):
        super(FixedUNetWithAttention, self).__init__()
